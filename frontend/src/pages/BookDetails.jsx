...
const BookDetails = () => {
  ...
  const isOwner = user && book.addedBy && book.addedBy._id === user.id;
  const hasUserReviewed = reviews.some(r => r.userId && r.userId._id === user?.id);
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="card mb-8">
        ...
        <div className="flex items-center justify-between">
          <p className="text-gray-600 dark:text-gray-400">Published: {book.year || book.publishedYear}</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Added by: {book.addedBy ? book.addedBy.name : 'Unknown User'}
          </p>
        </div>
